...
public class RoomListGUI extends javax.swing.JPanel {
    ...
    public void updateReservationTable() {
        ...
        if (com.crsystem.systemclient.reservation.CRSystemReservation.reservationList != null) {
            for (com.crsystem.systemclient.reservation.ReservationInfo info : com.crsystem.systemclient.reservation.CRSystemReservation.reservationList) {
